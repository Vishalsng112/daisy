"""Unit tests for Phase 6 CLI — src_new/cli.py.
...
class TestCreatePositionInferer:
    ...
    def test_llm_returns_correct_type(self):
        from src_new.daisy.position_inference import LLMPositionStrategy
    ...
    def test_llm_example_returns_correct_type(self):
        from src_new.daisy.position_inference import LLMExamplePositionStrategy
    ...
    def test_laurel_returns_correct_type(self):
        from src_new.daisy.position_inference import LAURELPositionStrategy
    ...
    def test_laurel_better_returns_correct_type(self):
        from src_new.daisy.position_inference import LAURELBetterPositionStrategy
    ...
    def test_hybrid_returns_correct_type(self):
        from src_new.daisy.position_inference import HybridPositionStrategy
...
class TestMainAlreadyVerified:
    ...
    @patch("src_new.cli.run_external_cmd")
