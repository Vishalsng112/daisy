...
Usage:
    python -m src.cli <path_to_code.dfy> --model <model> --localization LLM
"""
...
from src.llm.llm_configurations import MODEL_REGISTRY
...
from src.daisy import position_inference as _pos_mod  # noqa: F401
from src.daisy import assertion_inference as _assert_mod  # noqa: F401
from src.daisy import verification as _verif_mod  # noqa: F401

from src.daisy.position_inference.base import POSITION_REGISTRY
from src.daisy.assertion_inference.base import ASSERTION_REGISTRY
